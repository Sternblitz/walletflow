...
export function PremiumActivityChart({
    ...
    return (
        <div className="flex flex-col h-full">
            {/* Subtle inline legend - top right corner */}
            <div className="flex items-center justify-end gap-3 mb-2">
                <div className="flex items-center gap-1.5">
                    <div className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className="text-[10px] text-zinc-400">{chartConfig.totalStamps}</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <div className="w-2 h-2 rounded-full bg-purple-500" />
                    <span className="text-[10px] text-zinc-400">{chartConfig.totalRedemptions}</span>
                </div>
                <div className="flex items-center gap-1.5">
                    <div className="w-2 h-2 rounded-full bg-blue-500" />
                    <span className="text-[10px] text-zinc-400">{chartConfig.totalNewPasses}</span>
                </div>
            </div>
